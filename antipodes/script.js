(function () {
  require([
    ...
    Graphic, GraphicsLayer, Map, SceneView
  ) {
    document.querySelector('#mainContent').style.display = 'inline';

    var creditsNode = document.querySelector('#creditsNode');
    var altitudeANode = document.querySelector('#altitudeA');
    var altitudeBNode = document.querySelector('#altitudeB');
    ...
    sceneViewA.when(function () {
      ...
      sceneViewA.on('click,pointer-move', updateGraphicsAndElevations);
    });

    function updateGraphicsAndElevations (evt) {
